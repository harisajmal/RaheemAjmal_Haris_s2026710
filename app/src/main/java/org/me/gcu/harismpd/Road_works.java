...
public class Road_works extends AppCompatActivity {
    private ProgressDialog prog;
    private String TAG = Current_Incidents.class.getSimpleName();
    LinkedList<Item> roadworkList;
    LinkedList<Item> titles;
    ListView roadworkViewList;
    ...
    public void setViews(){
        ...
        roadworkViewList = (ListView) findViewById(R.id.roadworks_list);
        roadworkViewList.setOnItemClickListener( new AdapterView.OnItemClickListener() {
    ...
    private void populateList() {
        ...
        for (Item anItem : roadworkList) {
            titles.add(anItem);
        }

        roadworkViewList.setAdapter(new IncidentListAdapter(this, titles));
    }
